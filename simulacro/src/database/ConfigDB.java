...
public class ConfigDB {
    ...
    public static Connection openConnection(){
        try {
            ...
            String url = "jdbc:mysql://bhzqypo4epseirdzavfz-mysql.services.clever-cloud.com/bhzqypo4epseirdzavfz";
            String user = "uytkzqalxinzc8ii";
            String password = "nkyAmf2gyT4nT7KQQTW9";
            //establecer conexion
